    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('first_image',
                 models.ImageField(blank=True, help_text='Imagem que fica no início da página.', null=True,
                ...
                ('second_image',
                 models.ImageField(blank=True, help_text='Imagem que fica na parte sobre como plano de fundo do video.',
                                   null=True, upload_to='homepage/', verbose_name='Segunda Imagem')),
                ('second_video_url',
                ...
                (
                'whatsapp', models.CharField(help_text='Número para contato.', max_length=16, verbose_name='Whatsapp')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(auto_created=True, blank=True, db_index=True, verbose_name='ID')),
                ('first_image',
                 models.TextField(blank=True, help_text='Imagem que fica no início da página.', max_length=100,
                                  null=True, verbose_name='Primeira Imagem')),
                ('first_video_url',
                 models.CharField(blank=True, help_text='URL do primeiro vídeo, fica no início da página',
                                  max_length=255, null=True, verbose_name='Primeiro Video')),
                ('second_image',
                 models.TextField(blank=True, help_text='Imagem que fica na parte sobre como plano de fundo do video.',
